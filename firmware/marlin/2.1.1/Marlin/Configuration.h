...
#define STRING_CONFIG_H_AUTHOR "(magarage)"             // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 106.85
  #define DEFAULT_bedKi 18.30
  #define DEFAULT_bedKd 416.00
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 811.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30.6, -1, -2.47 }
